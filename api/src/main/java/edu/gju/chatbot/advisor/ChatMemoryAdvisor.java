...
public final class ChatMemoryAdvisor implements BaseChatMemoryAdvisor {
  ...
  public ChatMemoryAdvisor(
      ChatMemory chatMemory, String defaultConversationId, int order, Scheduler scheduler) {
  ...
  public ChatClientRequest before(ChatClientRequest chatClientRequest, AdvisorChain advisorChain) {
    ...
    List<Message> memoryMessages = chatMemory.get(conversationId).stream().toList();
  ...
  public static final class Builder {
    ...
    public ChatMemoryAdvisor build() {
      return new ChatMemoryAdvisor(
          this.chatMemory, this.conversationId, this.order, this.scheduler);
    }
  }
}
